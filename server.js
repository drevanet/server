...
app.get('/proxy', async (req, res) => {
  ...
  try {
    ...
    res.setHeader('Cache-Control', 'public, max-age=86400, immutable'); // Cache media chunks significantly; they never change
